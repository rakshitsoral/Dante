...
{%- endfor %}
 ...
 <!-- CTA Section with FIXED negative margins -->
<section class="max-w-4xl mx-auto mb-32 px-4 sm:mb-20 w-full">
  <div class="relative text-center">
    ...
    <p class="text-lg mt-8 mx-auto max-w-3xl sm:text-base sm:mt-6">Let's discuss how I can help establish your demand generation infrastructure and drive measurable growth.</p><br>
